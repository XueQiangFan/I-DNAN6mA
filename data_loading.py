...
import random
import xlrd
from calculate_16xLxL_matrix_map import constraint_matrix
        ...
        for j in range(seq_len):
            ...
            if j < seq_start:
                ...
                try:
                    ...
                    seq_one_hot[i, j, :] = 0.25
    return seq_one_hot, map_16xLxL, nrows


def data_loading(filename):
    seq01, map_16xLxL, nrows = seq_to_one_hot_map(filename)
    train_data = []
    for i in range(nrows):
        train_data.append((seq01[i], map_16xLxL[i]))
